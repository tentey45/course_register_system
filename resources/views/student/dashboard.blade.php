...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-4">
        ...
        <div class="wf-card d-flex align-items-center mb-3 py-3 px-3">
            ...
            <div>
                <h5 class="fw-bold mb-1" style="font-size: 1.1rem;">Welcome, {{ session('user_name', 'Student Name') }}</h5>
    ...
    <div class="col-12 col-lg-8">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="fw-bold mb-0">Enrolled Course Overview</h5>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-3">
            <div class="col">
                <a href="{{ route('student.courses.show', 'CS201') }}" class="text-decoration-none text-dark">
                    <div class="wf-card wf-card-hover d-flex align-items-center justify-content-between py-3 mb-0 h-100">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted" style="font-size: 0.75rem;">Year 2026 / Semester 1</div>
                            </div>
                        </div>
            ...
            <div class="col">
                <a href="{{ route('student.courses.show', 'CS202') }}" class="text-decoration-none text-dark">
                    <div class="wf-card wf-card-hover d-flex align-items-center justify-content-between py-3 mb-0 h-100">
                        <div class="d-flex align-items-center">
                            <span class="rounded-circle me-3" style="width: 14px; height: 14px; background-color: #6B21A8; display: inline-block;"></span>
                            <div>
            ...
            <div class="col">
                <a href="{{ route('student.courses.show', 'CS301') }}" class="text-decoration-none text-dark">
                    <div class="wf-card wf-card-hover d-flex align-items-center justify-content-between py-3 mb-0 h-100">
                        <div class="d-flex align-items-center">
                            <span class="rounded-circle me-3" style="width: 14px; height: 14px; background-color: #6B21A8; display: inline-block;"></span>
                            <div>
            ...
            <div class="col">
                <a href="{{ route('student.courses.show', 'CS305') }}" class="text-decoration-none text-dark">
                    <div class="wf-card wf-card-hover d-flex align-items-center justify-content-between py-3 mb-0 h-100">
                        <div class="d-flex align-items-center">
                            <span class="rounded-circle me-3" style="width: 14px; height: 14px; background-color: #6B21A8; display: inline-block;"></span>
                            <div>
